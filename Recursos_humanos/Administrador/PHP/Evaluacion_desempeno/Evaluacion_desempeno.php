...
<style type="text/css">
          ...
          <div class="">
            ...
            <div class="clearfix"></div>          
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Evaluacion Técnica<small> <a class="btn btn-info añadir " data-toggle="modal" data-target="#nuevoUsu" >
                    <span class="icono izquierda icon-plus"></span> Nueva evaluación</a></small></h2>
            ...
            <div class="clearfix"></div>
              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                 <form method="POST" action="evaluacion_psicologica/Busqueda.php">
      ...
      <thead> 
        ...
        <td></td>
           ...
           <?php
             ...
             $consulta= "SELECT id_tecnica, admin, empleado, componente, calificacion  FROM evaluacion_tecnica";
 ...
 <!--Ventana modal para registrar nueva evaluacion -->
 ...
 <div class="modal" id="nuevoUsu" tabindex="-1" role="dialog" aria-labellebdy="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <br>
                       <form role="form" action="evaluacion_tecnica/evaluacion_tecnica.php" method="POST" onsubmit="return validate()" name="empleadotabla">                  
                          ...
                          <div class="form-group">                            
                            ...
                            <?php
                            while($fila=mysqli_fetch_array($resulttecnica)){
   ...
   <div class="modal" id="editUsu" tabindex="-1" role="dialog" aria-labellebdy="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">                      
                    <form action="evaluacion_tecnica/actualizar_tecnica.php" method="POST" onsubmit="return validation()">                     
                     <input  id="id_tecnica" name="id_tecnica" type="hidden" ></input>       
                     <div class="form-group">
