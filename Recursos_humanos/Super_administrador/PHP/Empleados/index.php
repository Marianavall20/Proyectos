            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="Registro.php"><i class="fa fa-edit"></i> Registro de empleados </a>                  
                  </li>
                  ...
                  <li><a href="../Evaluacion_desempeno/Evaluacion_desempeno.php"><i class="fa fa-clone"></i>Evaluación de desempeño
                  </a>
                    ...
                    <br>
                       <form role="form" action="guardar.php" method="POST" onsubmit="return validate()" name="empleadotabla">                  
                          <div class="form-group">
                            <label >Nombres:</label>
                            <input class="form-control" id="usrnombre" name="nombres" type="text" placeholder="Nombres" autocomplete="off">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" id="usridentidad" name="doc_identidad" type="text" placeholder="Identidad" autocomplete="off">
                          ...
                          <div class="form-group">
                            ...
                            <input type="checkbox" name="privilegio" value="Administrador"> Administrador
                            <input type="checkbox" name="privilegio" value="Super_administrador"> Super_administrador
                          </div>
