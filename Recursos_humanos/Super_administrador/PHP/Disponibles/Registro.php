  ...
  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        <thead>
          <tr>
            ...
            <th></th>
      <?php
      $mysqli = new mysqli("mysql.gestionrecursoshumanis.org", "user_recursos", "Recursos2018", "db_recursoshumanos");   
      ...
      if ($resultado = $mysqli->query($consulta)) 
      {
        ...
        {         
          ...
          echo"<td>";           
          echo "<a data-toggle='modal' data-target='#editUsu' data-id='" .$fila[0] ."' data-area='" .$fila[1] ."' data-nombres='" .$fila[2] ."' data-descripcion='" .$fila[3] ."' data-cantidad='" .$fila[4] ."'><img src='../../imgadmin/plus.png'></span></a>";  
          echo"<td>";     
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">                      
                       <form action="Actualizar.php" method="POST">                    
                              ...
                              <div class="form-group">
                                <label for="edad">Descipción:</label>
