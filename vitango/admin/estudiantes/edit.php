...
<?php }else{ 
	...
	<div class="right_col" role="main">
		<section id="tit-prod" class="row">
			<div class="col-md-6">
				<h3 class="ps-sem">Editar Estudiante</h3>
			</div>
		</section><br>
		<section id="info-prod">
			<form action="<?php echo URL; ?>/admin/controller.php" method="post" enctype="multipart/form-data">
				<input type="hidden" name="edit_estudiante" value="edit_estudiante">
				<input type="hidden" name="id_estudiante" value="<?php echo $reg[0]; ?>">
				<div class="row">
					<div class="col-md-3 form-group">
						<label for="nombre_estudiante">Nombre: </label>
						<input type="text" id="nombre_estudiante" name="nombre_estudiante" class="form-control" value="<?php echo $reg[1]; ?>" required="required">
					</div>
					<div class="col-md-3 form-group">
				...
				<div class="row">
					...
					<div class="col-md-3 form-group">
						...
						<input type="password" id="pass" name="pass" class="form-control" placeholder="Contraseña del Estudiante" >
				...
				<div class="row">
					...
					<div class="col-md-4 form-group">
						...
						<input type="file" accept="image/png, image/jpeg, image/jpg" name="imagen_estudiante[]" id="imagen_estudiante" />
					</div>
				</div><br>
				<div class="row">
					<div class="col-md-3">
						...
						<input type="hidden" name="img_estudiante_ext" id="img_estudiante_ext" value="<?php echo $reg[11]; ?>">
					</div>
