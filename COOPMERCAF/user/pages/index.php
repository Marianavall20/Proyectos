...
<body>
    ...
    if (isset($_POST['inicio'])) {
        ...
        if ($usuario=="" || $contrasena=="") {
            ...
            $_SESSION['sesion_exito']=2; //2 es igual a error de campos vacios
        }else{
$_SESSION['sesion_exito']=3;//Error de datos incorrectos

        include('abrir_conexion.php');
            $resultados = mysqli_query($conexion, "SELECT * FROM $tabla_db11 WHERE usuario='$usuario' AND contrasena='$contrasena'");
                while($inicio = mysqli_fetch_array($resultados)) {
                    
                   $_SESSION['sesion_exito']=1;// Inició sesion
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12 text-right">
                    <h4 class="page-header">Bienvenido a nuestro sitio: COOPMERCAF</h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                <br/><br/><br/><br/>
            <div class="row">
                <div class="text-center">
                    <img src="../img/LOGOTIPO.png" style="width:50%">
                </div>
            </div>
        </div>
