...
<body>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h1 class="page-header">Mi pedido</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <br/>
    ...
    include('abrir_conexion.php');
            $consulta = mysqli_query($conexion, "SELECT * FROM $tabla_db7 WHERE clientes_id = '7' and estado_pedido = 'PEDIDO' ORDER BY id desc");
    include('cerrar_conexion.php')
        ...
        while ($fila = mysqli_fetch_array($consulta)) {
            include("abrir_conexion.php");
                ...
                $consultar_unidad = mysqli_query($conexion, "SELECT unidad_medida FROM $tabla_db12 where id = $fila[unidades_medida_id]");
                 $consultar_precio = mysqli_query($conexion, "SELECT precio FROM $tabla_db5 where productos_id = $fila[productos_id]");
                    ...
                    $total = ($precio['precio'] * ($fila['cantidad']));
            include('cerrar_conexion.php');
            echo "
                    <tr>
         ...
         <tr>
             ...
             <td colspan='3'><center>"."$".$total_pagar."</center></td>
         </tr>
         </table>";
    }
         else{
