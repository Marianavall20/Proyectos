            ...
            <div class="row col-md-offset-1">
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM $tabla_db10  WHERE id = '$id'";
                        $resultado = $conexion->query($query);
                        $row = $resultado->fetch_assoc();
                    ?>
                        <form action="actualizar_proveedores.php?id=<?php echo $id?>" method="POST" role="form" name="form1">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" disabled placeholder="Id" name="id" type="text" value="<?php echo $row['id']; ?>" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Empresa" name="empresa" type="text" value="<?php echo $row['empresa']; ?>" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="NIT" name="nit" type="text" value="<?php echo $row['nit']; ?>" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Representante Legal" name="representante" type="text" value="<?php echo $row['representante_legal']; ?>" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" value="<?php echo $row['documento_identidad']; ?>" placeholder="Numero documento de identidad" name="doc" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                               <select class="form-control" id=""  name="departamento" onchange="from(document.form1.departamento.value,'midiv','municipio.php')" required="required">
                                ...
                                <div class="form-group">
                                    <input class="form-control" value="<?php echo $row['correo2']; ?>" placeholder="Correo 2" name="correo2" type="e-mail" autofocus required="required">
                                </div>
                                <div class="form-group">
                                <div class="form-group">
                                    <input class="form-control" value="<?php echo $row['tel_fijo']; ?>" placeholder="Telefono" name="telefono" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" value="<?php echo $row['celular']; ?>" placeholder="Celular" name="celular" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" value="<?php echo $row['celular2']; ?>" placeholder="Celular 2" name="celular2" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    echo "<img width='150px' src='../img/monacho.gif'/>";
                                }
                          ?>
                                    </div>
                                    <div class="col-md-8">
                        ...
                        if (isset($_POST['enviar'])) {
                            ...
                            $query = "UPDATE $tabla_db10 SET empresa='$empresa', imagen='$imagen', nit='$nit', representante_legal='$representante', documento_identidad='$doc',celular='$celular',celular2='$celular2',tel_fijo='$telefono',correo='$correo',correo2='$correo2',departamentos_id='$departamento',municipios_id='$municipio',direccion='$direccion',usuario='$usuario',contrasena='$contrasena' WHERE id='$id'";
                            $resultado = $conexion->query($query);
