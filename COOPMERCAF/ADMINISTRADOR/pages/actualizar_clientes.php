            ...
            <div class="row col-md-offset-1">
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM $tabla_db3  WHERE id = '$id'";
                        $resultado = $conexion->query($query);
                        $row = $resultado->fetch_assoc();
                    ?>
                        <form action="actualizar_clientes.php?id=<?php echo $id?>" method="POST" role="form" name="form1">
                            <fieldset>
                               ...
                               <select class="form-control" id=""  name="departamento" onchange="from(document.form1.departamento.value,'midiv','municipio.php')" required="required">
                                ...
                                <div class="form-group">
                                    <input class="form-control" value="<?php echo $row['celular']; ?>" placeholder="Telefono" name="telefono" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" value="<?php echo $row['celular2']; ?>" placeholder="Telefono 2" name="telefono2" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                        ...
                        if (isset($_POST['enviar'])) {
                            ...
                            $query = "UPDATE $tabla_db3 SET nombres='$nombre',apellidos='$apellido',documento_identidad='$doc',celular='$telefono',celular2='$telefono2',correo='$correo',correo2='$correo2',departamentos_id='$departamento',municipios_id='$municipio',direccion='$direccion',usuario='$usuario',contrasena='$contrasena' WHERE id='$id'";
                            $resultado = $conexion->query($query);
