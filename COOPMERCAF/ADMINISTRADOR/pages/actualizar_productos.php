...
include("cerrar_conexion.php")
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            $query = "SELECT * FROM $tabla_db8  WHERE id = '$id'";
            $resultado = $conexion->query($query);
            $row = $resultado->fetch_assoc();
        ?>

                        <form action="actualizar_productos.php?id=<?php echo $row['id']?>" method="POST" role="form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Producto" name="producto" type="text" value="<?php echo $row['nombre']; ?>" autofocus required="required">
                                </div>
                        ...
                        if (isset($_POST['enviar'])) {
                            ...
                            include ("abrir_conexion.php");
                                ...
                                $query = "UPDATE $tabla_db8 SET categorias_productos_id='$categoria',nombre='$producto' WHERE id='$id'";
                                $resultado = $conexion->query($query);
