...
include("cerrar_conexion.php")
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            $query = "SELECT * FROM $tabla_db7  WHERE id = '$id'";
            $resultado = $conexion->query($query);
            $row = $resultado->fetch_assoc();
        ?>

                        <form action="actualizar_pedidos.php?id=<?php echo $row['id']?>" method="POST" role="form" name="form1">
                            <?php   
                include('abrir_conexion.php');
                ...
                include('cerrar_conexion.php');
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" value="<?php echo $row['fecha']?>" placeholder="Fecha de Registro" name="fecha-registro" type="date" autofocus required="required">
                                </div>
                                <div class="form-group">
                            ...
                            include('abrir_conexion.php');
                               ...
                               $estado = $_POST['estado'];
                            mysqli_query($conexion, "UPDATE $tabla_db7 SET categorias_productos_id='$categoria',productos_id='$producto',unidades_medida_id='$unidad',cantidad='$cantidad',fecha='$fecha',clientes_id='$cliente',estado_pedido='$estado' WHERE id='$id'");

                            include('cerrar_conexion.php');

                             echo "

                                <script>alert(\"Actualizado exitosamente.\");window.location='pedidos.php';</script>
