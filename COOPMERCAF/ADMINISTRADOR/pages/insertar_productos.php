...
$consulta = mysqli_query($conexion,"SELECT * FROM $tabla_db2");  //Consulta a la tabla Categorias
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row col-md-offset-1">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <form action="insertar_productos.php" method="POST" role="form">
                            <fieldset>
                               ...
                               <select class="form-control" name="categoria">
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Producto" name="producto" type="text" value="" autofocus required="required">
                                </div>
...
include("abrir_conexion.php");
    ...
    mysqli_query($conexion, "INSERT INTO $tabla_db8 (categorias_productos_id, nombre) VALUES ('$categoria','$nombre')");
