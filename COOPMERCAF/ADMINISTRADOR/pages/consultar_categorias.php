...
<?php
    ...
    include('abrir_conexion.php');
            $consulta = mysqli_query($conexion, "SELECT * FROM $tabla_db2 ORDER BY id desc");
        ...
        while ($fila = mysqli_fetch_array($consulta)) {
            echo "
                    <tr>
                        ...
                        <td><center><a href='actualizar_categorias.php?id=$fila[id]' class='btn btn-success'>Editar</a></center></td>
                        <td><center><a href='eliminar_categorias.php?id=$fila[id]' class='btn btn-danger'>Eliminar</a></center></td>
                    </tr>
              ";
        }
         echo "</table>";
