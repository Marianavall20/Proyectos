...
$consulta = mysqli_query($conexion,"SELECT id,departamento FROM $tabla_db4 ORDER BY departamento asc");
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            $query = "SELECT * FROM $tabla_db2  WHERE id = '$id'";
            $resultado = $conexion->query($query);
            $row = $resultado->fetch_assoc();
        ?>

                        <form action="actualizar_categorias.php?id=<?php echo $row['id']?>" method="POST" role="form">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" disabled placeholder="Id" name="id" type="text" value="<?php echo $row['id']; ?>" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Categoria" name="cat" type="text" value="<?php echo $row['categoria']; ?>" autofocus required="required">
                                </div>
                            ...
                            if ($resultado)
                             {
                                 ...
                                 header("location:consultar_categorias.php");
                             }
                              else
                              {
                                 echo "no se modifico";
