...
<body>
    ...
    include('abrir_conexion.php');
            $consulta = mysqli_query($conexion, "SELECT * FROM $tabla_db10 ORDER BY id desc");
            ...
            echo "
                    <tr>
                         ...
                         <?php
                            if ($fila['imagen']) {
                               ?>
                                    <td><center><img width="150px" src="data:image/jpg;base64,<?php echo base64_encode($fila['imagen']);?>"/></center></td>
                               <?php
                            }else{
                                    echo "<td><center><img width='150px' src='../img/monacho.gif'/></center></td>";
                          ?>
                    ...
                    <?php
                        ...
                        echo "
                          ...
                          <td>".$municipios['municipios']."</td>
                          <td><center><a href='actualizar_proveedores.php?id=$fila[id]' class='btn btn-success'>Editar</a></center></td>
                        <td><center><a href='eliminar_proveedores.php?id=$fila[id]' class='btn btn-danger'>Eliminar</a></center></td>
                    </tr>
              ";
        }
         echo "</table>";
