...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="insertar_usuarios.php">Consultar</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
    ...
    include('abrir_conexion.php');
            $consulta = mysqli_query($conexion, "SELECT * FROM $tabla_db8 ORDER BY id desc");
    include('cerrar_conexion.php')
        ...
        while ($fila = mysqli_fetch_array($consulta)) {
            include("abrir_conexion.php");
                $consultar_categorias = mysqli_query($conexion, "SELECT categoria FROM $tabla_db2 where id = $fila[categorias_productos_id]");
            ...
            echo "
                    <tr>
                        ...
                        <td><center><a href='actualizar_productos.php?id=$fila[id]' class='btn btn-success'>Editar</a></center></td>
                        <td><center><a href='eliminar_productos.php?id=$fila[id]' class='btn btn-danger'>Eliminar</a></center></td>
                    </tr>
              ";
        }
         echo "</table>";
