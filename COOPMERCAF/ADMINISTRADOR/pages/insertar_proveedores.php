...
include("cerrar_conexion.php");
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row col-md-offset-1">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <form action="insertar_proveedores.php" method="POST" role="form" name="form1" enctype="multipart/form-data">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="NIT" name="nit" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Empresa" name="empresa" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Representante legal" name="representante" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Documento de identidad" name="doc" type="e-mail" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Celular 1" name="celular1" type="e-mail" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Celular 2" name="celular2" type="e-mail" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Teléfono" name="telefono" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Correo 1" name="correo1" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Correo 2" name="correo2" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Direccion" name="direccion" type="text" value="" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Usuario" name="usuario" type="text" value="" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Contraseña" name="contrasena" type="password" value="" autofocus required="required">
                                </div>
                                <div class="form-group">
    ...
    include("abrir_conexion.php");
        ...
        mysqli_query($conexion, "INSERT INTO $tabla_db10 (empresa,imagen,nit,representante_legal,documento_identidad,celular,celular2,tel_fijo,correo,correo2,departamentos_id,municipios_id,direccion,usuario,contrasena) VALUES ('$empresa','$imagen','$nit','$representante','$doc','$celular1','$celular2','$telefono','$correo1','$correo2','$departamento','$municipio','$direccion','$usuario','$contrasena')");
