        ...
        <div id="page-wrapper">
            <div class="row col-md-offset-1">
                <div class="col-lg-10 text-center">
                    <h1 class="page-header">Insertar Categoría</h1>
                </div>
                <div class="row">
                    <div class="col-md-10">
                        <form action="insertar_categorias.php" method="POST" role="form">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Categoría" name="cat" type="text" value="" autofocus required="required">
                                </div>
                            ...
                            if (isset($_POST['enviar'])) {
                                ...
                                mysqli_query($conexion, "INSERT INTO $tabla_db2 (categoria) VALUES ('$categoria')");
