...
<body>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 text-justify">
                        <a href="#insertar" class="btn btn-lg btn-default page-scroll" data-toggle="modal">Insertar Promociones</a>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            ...
            <!-- header de la ventana -->
                ...
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h2 class="modal-title text-center">INSERTAR PROMOCIONES</h2>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <form action="promociones.php" method="POST" role="form" name="form1" enctype="multipart/form-data">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Titulo" name="titulo" type="text" autofocus required="required">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Fecha de inicio" name="fecha_inicio" type="date" autofocus required="required">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Fecha de finalizacion" name="fecha_finalizacion" type="date" autofocus required="required">
                                </div>
                                <div class="form-group">
                    ...
                    include('abrir_conexion.php');
                            ...
                            {
                                mysqli_query($conexion,"INSERT INTO $tabla_db9 (titulo,imagen,precio,descripcion,fecha_inicio,fecha_finalizacion) values ('$titulo','$imagen','$precio','$descripcion','$fecha_inicio','$fecha_finalizacion')");
                            }
    ...
    <div class="row">
                <?php 
    include('abrir_conexion.php');
            $consulta = mysqli_query($conexion, "SELECT * FROM $tabla_db9 ORDER BY id desc");
    include('cerrar_conexion.php')
             ?>
             <?php 
        ...
        while ($fila = mysqli_fetch_array($consulta)) {
            echo "
                    ...
                    ?>
                        <td><center><img height="150px" src="data:image/jpg;base64,<?php echo base64_encode($fila['imagen']);?>"/></center></td>
                    <?php
                        echo "
                        ...
                        <td><center><a href='actualizar_promociones.php?id=$fila[id]' class='btn btn-success'>Editar</a></center></td>
                        <td><center><a href='eliminar_promociones.php?id=$fila[id]' class='btn btn-danger'>Eliminar</a></center></td>
                    </tr>
              ";
        }
         echo "</table>";
