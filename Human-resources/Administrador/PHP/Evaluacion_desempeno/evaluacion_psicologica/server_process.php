<?php
	...
	*/
	...
	/* Nombre de La Tabla */
	$sTabla = "evaluacion_psicologica";
	
	/* Array que contiene los nombres de las columnas de la tabla*/
	$aColumnas = array( 'id', 'empleado', 'admin', 'componente', 'calificacion','area','periodo_evaluado','cargo_empleado','tiempo_servicio','fecha','pregunta1','pregunta_nueva','justificacion');
...
$row[] = "<td><a href='modificar.php?id=".$aRow['id']."' data-toggle='modal' data-target='#confirm-edit'><span class='glyphicon glyphicon-pencil'></span></a></td>";
