                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-star"></i>Evaluación desempeño<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="../Evaluacion_desempeno/evaluacion_psicologica/index.php">Evaluación psicológica</a></li>        
                    </ul>
                  </li>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
              <!-- Formulario-->
              <form method="POST" action="add_data.php" class="form-horizontal form-label-left">
              ...
              <div class="item form-group">
               ...
               <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="date" class="form-control" id="recipient-name" name="sales_date" >
                </div>
              </div>
