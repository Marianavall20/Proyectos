	...
	<body>
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
				...
				<div class="form-group">
					<label for="identidad" class="col-sm-2 control-label">Identidad</label>
					<div class="col-sm-10">
						<input type="tel" class="form-control" id="identidad" name="identidad" placeholder="Identidad" value="<?php echo $row['identidad']; ?>" >
					</div>
				</div>
			...
			<div class="form-group">
					...
					<div class="col-sm-10">
						<select class="form-control" id="privilegio" name="privilegio">
							<option value="Usuario" <?php if($row['privilegio']=='Usuario') echo 'selected'; ?>>Usuario</option>
